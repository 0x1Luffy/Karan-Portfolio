      ...
      <div className="relative w-full flex flex-col space-y-4">
        ...
        >
          <span className="text-gray-600 font-Header text-2xl">
            <span style={{ textDecoration: 'underline', textDecorationColor: 'red' }}>This site</span>{" "}
            {ShowText ? (
              <motion.span
          ...
          <span className="text-gray-500 text-md">
            <span className="font-bold">www.karan.vercel.app </span>
            unexpectedly{" "}
            {ShowText ? (
              <motion.span
